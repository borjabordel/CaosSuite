...
function varargout = ModificaCubico(varargin)
    ...
    % Last Modified by GUIDE v2.5 03-Jul-2014 22:12:09

    % Begin initialization code - DO NOT EDIT
    gui_Singleton = 1;
    gui_State = struct('gui_Name',       mfilename, ...
                       'gui_Singleton',  gui_Singleton, ...
                       'gui_OpeningFcn', @ModificaCubico_OpeningFcn, ...
...
% --- Executes just before ModificaHabitual is made visible.
    function ModificaCubico_OpeningFcn(hObject, eventdata, handles, varargin)
