...
%
% Función que calcula los exponentes de Lyapunov del sistema de Lorenz hipercaótico para
% unos valores dados
%
% Entradas:
...
function [lambda] = exponentesLyapunovGS (a, b, c, d, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraLorenz_and_Jacobiano(a, b, c, d, y, [t t+dt]);
