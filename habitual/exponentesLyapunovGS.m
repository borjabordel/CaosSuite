...
%
% Función que calcula los exponentes de Lyapunov del circuito de Chua para
% unos valores dados
%
% ENTRADAS:
% R : Resistencia de control del circuito
% E : Codo de la no linealidad
% Ga : Pendiente de la zona central de la no linealidad
% Gb : Pendiente de las zonas exteriores de la no linealidad
% C1 : Condensador pequeño del circuito
% C2 : Condensador grande del circuito
% L : Bobina
...
function [lambda] = exponentesLyapunovGS (R, E, Ga, Gb, C1, C2, L, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraChua_and_Jacobiano(R, E, Ga, Gb, C1, C2, L, y, [t t+dt]);
