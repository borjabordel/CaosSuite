...
%
% Función que calcula los exponentes de Lyapunov del sistema PV1 para
% unos valores dados
%
% ENTRADAS:
% 
% ci : Condiciones iniciales del circuito
% alfa, beta, gamma : Parámetros del sistema PV1
%
% SALIDAS:
...
function [lambda] = exponentesLyapunovGS (alfa, beta, gamma, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraPV1_and_Jacobiano(alfa, beta, gamma, y, [t t+dt]);
