...
%
% Función que calcula los exponentes de Lyapunov del circuito de Van Der Pol para
% unos valores dados
%
% ENTRADAS:
% mu : Amotiguamiento
...
function [lambda] = exponentesLyapunovGS (mu, A, omega, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, ~] = IntegraVanDerPolForzado_and_Jacobiano(mu, A, omega, y, [t t+dt]);
