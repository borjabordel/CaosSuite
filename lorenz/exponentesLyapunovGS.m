...
%
% Función que calcula los exponentes de Lyapunov del sistema de Lorenz para
% unos valores dados
%
% Entradas:
...
function [lambda] = exponentesLyapunovGS (sigma, ro, beta, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraLorenz_and_Jacobiano(sigma, ro, beta, y, [t t+dt]);
