...
% a, b, c, d: Parámetros de la no linealidad 
...
function [lambda] = exponentesLyapunovGS (R, a, b, c, d, C1, C2, L, ci, N)
   ...
   % Condiciones iniciales
    ...
    for num_iter = 1:N
       ...
       [Y, tiempo] = IntegraChua_and_Jacobiano(R, a, b, c, d, C1, C2, L, y, [t t+dt]);
    ...
    % Para esta aplicación mandamos todos los valores
    lambda = lambdaTemp;
end
